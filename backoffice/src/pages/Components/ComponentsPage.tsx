...
const ComponentsPage: React.FC = () => {
  ...
  const filteredComponents = componentsList.filter(component => {
    const matchesCategory = selectedCategory === 'all' || component.category.id === selectedCategory;
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-900">Gestion des composants</h1>
      ...
      {filteredComponents.length === 0 && (
        <Card className="p-8 text-center">
          <p className="text-gray-500">Aucun composant trouvé avec les filtres actuels.</p>
        </Card>
      )}
          ...
          <div className="space-y-6">
            <div className="flex items-start space-x-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-600 mb-2">{selectedComponent.brand} - {selectedComponent.model}</p>
                <Badge variant="secondary">{selectedComponent.category.name}</Badge>
            ...
            <div>
              <h4 className="text-lg font-medium text-gray-900 mb-3">Spécifications</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
